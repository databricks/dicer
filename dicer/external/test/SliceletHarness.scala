    ...
    fakeReadinessProviderOpt match {
      ...
      case None =>
        throw new UnsupportedOperationException(
          "SliceletHarness was not initialized with a fake readiness provider, so its " +
