...
/** The [[SliceLookupHarness]] that exercises the Scala [[SliceLookup]] implementation. */
class ScalaSliceLookupHarness(
    sliceLookup: SliceLookup,
    subscriberDataSupplier: () => SubscriberData)
    extends SliceLookupHarness {
